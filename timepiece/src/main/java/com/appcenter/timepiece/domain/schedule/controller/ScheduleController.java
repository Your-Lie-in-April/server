package com.appcenter.timepiece.domain.schedule.controller;
...
public class ScheduleController {
    ...
    public CommonResponse<List<?>> findMembersSchedules(@PathVariable Long projectId,
        ...
        return CommonResponse.success("프로젝트 스케줄 조회 성공",
                scheduleService.findMembersSchedules(projectId, condition, userDetails));
    }
    ...
    public CommonResponse<List<?>> findMembersSchedulesWithoutMe(@PathVariable Long projectId,
                                                                 ...
                                                                 @AuthenticationPrincipal UserDetails userDetails) {
        return CommonResponse.success("프로젝트 스케줄 조회 성공",
                scheduleService.findMembersSchedulesWithoutMe(projectId, condition, userDetails));
    }
    ...
    public CommonResponse<?> findSchedule(@PathVariable Long projectId,
                                          ...
                                          @RequestParam @Schema(example = "2024-02-01") LocalDate condition,
                                          @AuthenticationPrincipal UserDetails userDetails) {
        return CommonResponse.success("멤버 스케줄 조회 성공",
                scheduleService.findSchedule(projectId, memberId, condition, userDetails));
    }
